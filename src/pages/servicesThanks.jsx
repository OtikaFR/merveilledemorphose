...
import Main_picture from "../../public/assets/thanks/thanksRent.webp"
    ...
    <>
        <div className="w-[100vw] flex flex-col items-center mb-20">
            ...
            <div className="w-full">
                <Image src={Main_picture} className='object-cover h-[40vh] object-[40%_60%] w-full' alt='Logo' priority={true}/>
            </div>
